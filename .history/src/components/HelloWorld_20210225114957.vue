    ...
    <el-dialog :visible.sync="charRecordImgVisible"  :before-close="closeImg" :fullscreen="true"  :modal="false" custom-class="charRecordImg">
      ...
      <el-row class=" el-image-viewer__actions" style="position:fixed;bottom:5%;right:10%;background:white;border:1px solid black;width:550px">
        <el-row class="el-image-viewer__actions__inner" style="width:500px">
          ...
          <i v-show="clickEdge != 13" :style="{color:clickEdge == 14 ? 'red' : 'black',border:clickEdge == 14 ? '1px solid black' : ''}" class="el-icon-document" @click="edit" title="输入文字"></i>
          ...
          <i v-show="clickEdge != 13" :style="{color:clickEdge == 15 ? 'red' : 'black',border:clickEdge == 15 ? '1px solid black' : ''}" class="el-icon-s-grid" @click="masaike" title="马赛克"></i>
          ...
          <i v-show="clickEdge != 13"  :style="{color:clickEdge == 5 ? 'red' : 'black',border:clickEdge == 5 ? '1px solid black' : ''}" class="el-icon-crop" @click="sOpen" title="方块"></i>
          <i v-show="clickEdge != 13"  :style="{color:clickEdge == 6 ? 'red' : 'black',border:clickEdge == 6 ? '1px solid black' : ''}" class="el-icon-s-help" @click="aim" title="圆形"></i>
