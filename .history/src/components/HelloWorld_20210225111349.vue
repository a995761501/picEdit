<template>
  ...
  >
    未读:{{unReadNum}}/总计:{{chatRecordBusiness.length}}--{{charType}}
    <virtual-list
      v-if="menuKey"
      :data-key="'id'"
      :data-sources="chatRecordBusiness"
      :data-component="itemComponent"
      ref="virtualList"
      id="chart"
      @scroll="virtualMeth($event)"
    ></virtual-list>
    ...
    <el-dialog :visible.sync="charRecordImgVisible"  :before-close="closeImg" :fullscreen="true"  :modal="false" custom-class="charRecordImg">
      <!-- <span class="dialog-footer" >
        <el-button type="info" size="mini" @click="closeImg">关闭</el-button>
        <el-button type="success" size="mini" @click="imgBaseSubmit">发送</el-button>
      </span> -->
